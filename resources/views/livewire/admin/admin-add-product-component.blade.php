                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <textarea class="form-control" cols="30" rows="10" id="short_description" placeholder="Short Description" wire:model="short_description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <textarea class="form-control" cols="30" rows="10" id="description" placeholder="Description" wire:model="description"></textarea>
                                    @error('description')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
